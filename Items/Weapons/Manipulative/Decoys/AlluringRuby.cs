...
{
    class AlluringRuby : DecoyItem
    {
        public override int DecoyType => ModContent.NPCType<AlluringRubyDecoy>();
        public override int CooldownSeconds => 35;
        public override string DecoyName => "alluring ruby";
        public override int DefaultHP => 175;
    ...
    {
        public override string Texture => "Wisplantern/Items/Weapons/Manipulative/Decoys/AlluringRuby";
    ...
    class RubySoul : ModProjectile
    {
        ...
        public override void AI()
        {
            Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.RedTorch, Projectile.velocity.X, Projectile.velocity.Y);
