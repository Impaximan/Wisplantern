...
{
    internal class IronStaff : MinionStaff
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<IronSummon>();
            Item.shoot = ModContent.ProjectileType<IronSummonProjectile>();
            Item.autoReuse = true;
        }
    ...
    class IronSummonProjectile : ModProjectile
    {
