...
{
    internal class LeadStaff : MinionStaff
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<LeadSummon>();
            Item.shoot = ModContent.ProjectileType<LeadSummonProjectile>();
        }
    ...
    class LeadSummonProjectile : ModProjectile
    {
